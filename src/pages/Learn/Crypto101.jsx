...
const Crypto101 = () => {
  ...
  const blogPostss = [
    ...
    },
    {
      ...
      excerpt: 'Explore advanced TypeScript patterns that can help you write more maintainable and type-safe code.',
      author: 'TypeScript Expert',
      date: 'June 2, 2023',
      readTime: '8 min',
      likes: 35,
      comments: 5,
      imageUrl: 'https://via.placeholder.com/600x400?text=TypeScript',
      category: 'TypeScript'
    },
    {
      id: 3,
      title: 'CSS Grid Layout Techniques',
      excerpt: 'Master modern layout techniques using CSS Grid to create responsive designs with less code.',
      author: 'CSS Wizard',
      date: 'June 10, 2023',
      readTime: '6 min',
      likes: 28,
      comments: 3,
      imageUrl: 'https://via.placeholder.com/600x400?text=CSS+Grid',
      category: 'CSS'
    }
  ];
              ...
              <article
                ...
                <div className="blog-card-content">
                  ...
                  <div className="meta-info">
                    ...
                    <span><FaClock /> {post.readtime} read</span>
                  </div>
                </div>
              </article>
            ))
